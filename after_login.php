      ...
      <div class="details">
        ...
        <div class="data">
            ...
            <div class="row">
              <div class="textbox">
                <label><b> Pno: </b></label>
                <input type="text" name="pno" style="margin-left: 113px;border:1px solid red;"><br>
              </div>
              <div class="textbox">
                <label class="fname"><b> Name: </b></label>
                <input type="text" id="fname" name="name1" class="textbox" style="margin-left: 95px;border:1px solid red;" ><br>
              </div>
              <div class="textbox">
                <label for="fname"><b> Level: </b></label>
                <input type="text" id="level2" name="level2" style="margin-left: 102px;border:1px solid red;"><br>
              </div>
            </div>
            </div>
            <div class="document">
